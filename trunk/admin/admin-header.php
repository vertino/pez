...
<html dir="ltr" lang="en">
	<head>
		...
		<script type="text/javascript" src="../pz-includes/js/functions.js"></script>
	...
	<body>
		<div id="page">
			<div id="header">
				...
				<ul id="menu">
					<li class="first<?php if ($_SERVER['SCRIPT_NAME'] == '/pez/pz-admin/profile.php') echo ' current'; ?>"><a href="profile.php">Profile</a></li>
					...
					<li class="<?php if ($_SERVER['SCRIPT_NAME'] == '/pez/pz-admin/settings.php') echo ' current'; ?>"><a href="settings.php">Settings</a></li>
					<li class="<?php if ($_SERVER['SCRIPT_NAME'] == '/pez/pz-admin/style.php') echo ' current'; ?>"><a href="style.php">CSS Style</a></li>
